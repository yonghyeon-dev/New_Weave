...
export default function ChatInterface() {
  ...
  return (
    <div className="flex h-full">
      ...
      <div className={`
        fixed lg:relative inset-y-0 left-0 z-40 w-64 bg-white border-r border-border-light
            ...
            {sessions.map(s => (
              <div
                ...
                className={`
                  ...
                  ${s.id === session?.id 
                    ? 'bg-weave-primary-light text-white' 
                    : 'hover:bg-bg-secondary'
                  }
                `}
              >
                <Typography variant="body2" className="font-medium truncate">
                  {s.messages[0]?.content.slice(0, 30) || '새 대화'}
                </Typography>
                <Typography variant="body2" className="text-xs opacity-70">
